...
<head>
  ...
  <title>Dashboard - Admin NyatatJO</title>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Rp.<?$pemasukan_hari_ini = isset($row['$pemasukan_hari_ini']) ? $row['$pemasukan_hari_ini'] : '';?>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Rp.<?$pemasukan_hari_ini = isset($row['$pengeluaran_hari_ini']) ? $row['$pengeluaran_hari_ini'] : '';?></div>
                    </div>
                    <div class="col-auto">
